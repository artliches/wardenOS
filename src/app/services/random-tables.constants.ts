...
export const ITEMS = [
  {amount: 1, title: 'Advanced Battle Dress        ' , descrip: 'Heavy combat outfit worn by marines in battletorn offworld engagements. It confers a <b>+15%</b> bonus to the wearer’s Armor save. It has a small exo-skeleton that allows the wearer to carry twice what they normally could.'},
  {amount: 1, title: 'Automed                 ' , descrip: 'Nanotech pills that assist your body in repairing damage. They give <b>+10%</b> to Body saves meant to repel disease, poison, and attempts to heal, and <b>+10%</b> to Fear saves made to reduce Stress.'},
  {amount: 1, title: 'Binoculars                   ' , descrip: '20x magnification. Often come with thermal and night vision options.'},
  {amount: 1, title: 'Bioscanner                   ' , descrip: 'Allows the user to scan the immediate area for signs of life. Generally can scan for 100m in all directions, without being blocked by most known metals. Can tell the location of signs of life, but not what that life is.'},
  {amount: 1, title: 'Body Cam                     ' , descrip: 'A camera worn on your clothing that can stream video back to a control center so that your other crew members can see what you’re seeing.'},
  {amount: 1, title: 'Camping Gear                 ' , descrip: 'Tent, Canteen, Stove, Backpack, Sleeping Bag'},
  {amount: 1, title: 'Cybernetic Diagnostic Scanner' , descrip: 'Allows the user to scan androids and other cybernetic organisms in order to diagnose any physical or mental issues they may be having. Often distrusted by androids. Can be used as a locating device for synthetic organisms.'},
  {amount: 1, title: 'Electronic Tool Set          ' , descrip: 'A full set of tools for doing detailed repair or construction work on electronics. Confers <b>+10%</b> to rolls seeking to repair electronics.'},
  {amount: 1, title: 'Emergency Beacon             ' , descrip: 'A small device that sends up a flare and then emits a loud beep every few seconds. Additionally, sends out a call on all radio channels to ships, or vehicles in the area. Can be configured to be silent, or to only make calls on known channels.'},
  {amount: 1, title: 'Field Recorder               ' , descrip: 'Used to research alien flora and fauna in the field. Can take vital signs, DNA samples, and perform basic genetic and material analysis on foreign objects.'},
  {amount: 1, title: 'First Aid Kit                ' , descrip: 'When used adds <b>+10%</b> to rolls made to bandage wounds and stop bleeding.'},
  {amount: 1, title: 'Flashlight                   ' , descrip: 'Handheld or shoulder mounted, illuminates 20m ahead of the user.'},
  {amount: 1, title: 'Hazard Suit                  ' , descrip: 'A standard suit for scientists to wear on alien planets. Not built for outerspace travel like the vaccsuit, but does provide air filtration and a small supply of air as well as <b>+5%</b> Armor save.'},
  {amount: 1, title: 'Heads-Up Display             ' , descrip: 'Often worn by marines, the HUD allows the wearer to see through the body cams of others in their unit, and tap into their guns’ smart-link capabilities.'},
  {amount: 1, title: 'Infrared Goggles             ' , descrip: 'Allows the wearer to see heat signatures, sometimes several hours old.'},
  {amount: 1, title: 'Locator                      ' , descrip: 'When worn, allows crew members at a control center (or on the bridge of a ship) to track the location of the wearer.'},
  {amount: 1, title: 'Lockpick Set                 ' , descrip: 'A highly advanced set of tools meant for hacking basic airlock and electronic door systems. Confers <b>+10%</b> on rolls made to open these doors.'},
  {amount: 1, title: 'Long-range Comms             ' , descrip: 'For use in ship-to-surface comunication.'},
  {amount: 1, title: 'Mag-Boots                    ' , descrip: 'Grants a magnetic grip to the wearer, allowing them to easily to walk on the surface of a ship (in space, while docked or free-floating), or metal based asteroids.'},
  {amount: 1, title: 'Medscanner                   ' , descrip: 'Allows the user to scan a living or dead body and to analyze it for disease or abnormalities, without having to do a biopsy (or autopsy).'},
  {amount: 1, title: 'MRE                   ' , descrip: '“Meals, Ready-to-Eat.” Self-contained, individual field rations in lightweight packaging. Each one has sufficient sustenance for a single person for one day (does not include water).'},
  {amount: 1, title: 'Oxygen Tank                  ' , descrip: 'When attached to a vaccsuit allows up to 12 hours of oxygen under normal circumstances. 4 hours under stressful circumstances. Explosive.'},
  {amount: 1, title: 'Pain Pills              ' , descrip: 'When ingested immediately heals 1d10 points of damage and lowers Stress by 1. There is a danger of addiction and/or overdose if used frequently.'},
  {amount: 1, title: 'Radio Jammer                 ' , descrip: 'When activated, renders incomprehensible the radio signals of all within 100km.'},
  {amount: 1, title: 'Rebreather                   ' , descrip: 'When worn, filters air and allows for underwater breathing for up to twenty minutes at a time without resurfacing.'},
  {amount: 1, title: 'Short-range Comms            ' , descrip: 'Allows communication from ship-to-ship within a reasonable distance, as well as surface-to-surface within a dozen kilometers.'},
  {amount: 1, title: 'Standard Battle Dress        ' , descrip: 'This light plated armor is the standard dress for marines going into combat and confers a <b>+10%</b> bonus to the wearer’s Armor save.'},
  {amount: 1, title: 'Standard Crew Attire         ' , descrip: 'Coveralls, leather jackets, sneakers, tank top or ragged tee. The standard outfit worn by crew members aboard spacecraft. Standard assumed attire for all classes.'},
  {amount: 1, title: 'Stimpak                 ' , descrip: 'Grants an immediate 2d10 to Health and temporarily increases Strength and Combat by 2d10 each for 1d10 hours. There is a danger of addiction and/or overdose if used frequently.'},
  {amount: 1, title: 'Survey Kit                   ' , descrip: 'When used on the surface of a planet, allows for quick mapping of a nearby few kilometers, as well as data on air breathability, gravity, and other important notable features of the surrounding landscape.'},
  {amount: 1, title: 'Vaccsuit                     ' , descrip: 'Allows for movement in space without suffering penalties from radiation or lack of oxygen. Requires an oxygen tank to breathe. Often used with Mag-boots and a Rigging Gun. Confers <b>+7%</b> to Armor saves.'},
  {amount: 1, title: 'Water Filter                 ' , descrip: 'Can pump 50 liters of filtered water an hour from even the most brackish swamps.'},
  {amount: 1, title: 'Kano X9 Combat Shotgun', dmg: '2d10', crit: 'Knockdown', range: '10m 20m 30m  ', ammo: 'Knockback on hit. 1/2 damage at medium range. 1/4 damage at long range.', shots: '4   ', special: 'Audio rangefinder: Beeps when non-friendlies approach within 10m.'},
  {amount: 1, title: 'Crowbar       ', dmg: '1d10        ', range: 'CQC Only     ', special:      '+5 (Mechanical Repair). Confers Advantage on Strength checks to open jammed airlocks, or lift heavy objects.'},
  {amount: 1, title: 'Ramhorn 1 Flamethrower', dmg: '<u>2d10</u>', range: '2m 10m 20m   ', shots: '8   ', special:      'Body save or get set on fire and take <u>1d10</u> dmg. per turn.'},
  {amount: 1, title: 'Peabody Flare Gun     ', dmg: '1d10        ', range: '5m 10m 20m   ', ammo: 'High-intensity flare: Visible from 25km away.                                        ', shots: '2   ', special: ''},
  {amount: 1, title: 'Halls B Series Foam Gun      ', dmg: 'N/A         ', crit: 'No save               ', range: '<1m 5m 10m   ', ammo: 'Quick-hardening foam: Body/instinct save to avoid or become stuck. Foam coveres 5sqm.', shots: '10'  , special:      'Fire retardant.'},
  {amount: 1, title: 'Frag Grenade', dmg: '<u>1d10</u>', range: '20m 30m 40m  ', ammo: 'Deals damage to all within a 15m radius.                                             ', shots: '1   ', special:      'Can often do 1MDMG to a ship if placed in their engine room or bridge.'},
  {amount: 1, title: 'EVA MK-II Hand Welder   ', dmg: '1d10        ', range: 'CQC Only     ', shots: '∞   ', special:      'Ultra heat emitter: Cuts through airlocks/heavy doors. -10 vs. Armor Save'},
  {amount: 1, title: 'MNC Model A Laser Cutter  ', dmg: '1d% or 1MDMG', range: '25m 250m 700m', ammo: 'Takes 1 round to re-charge between shots.                                            ', shots: '6   ', special:      'Takes 1 hour to re-charge from a power source, or 6 hours in sunlight.'},
  {amount: 1, title: 'Rosco 556 Nail Gun      ', dmg: '2d10        ', crit: 'Double damage         ', range: '<1m 5m 10m   ', ammo: 'Heavy Duty Nails: -10 vs. Armor Save                                                 ', shots: '32  ', special:   ''},
  {amount: 1, title: 'F20 “Arbiter” Pulse Rifle   ', dmg: '5d10        ', crit: 'Double damage         ', range: '15m 125m 300m', ammo: 'Phosphorus Rounds. Fully automatic.                                                  ', shots: '1(3)', special:      'Smart-link system: +5 (Combat if wearing HUD). Pump-Action Grenade Launcher: Holds 6 frag grenades.'},
  {amount: 1, title: 'FN “Slug Gun” Revolver      ', dmg: '3d10        ', crit: 'Knockdown             ', range: '2m 30m 125m  ', ammo: 'Kineti-slugs: -5 vs. Armor Save.                                                     ', shots: '8   ', special:   ''},
  {amount: 1, title: 'HAN-290 Rigging Gun   ', dmg: '2d10        ', crit: 'Impale. Triple damage.', range: '10m 30m 100m ', ammo: 'Micro-filament: 500m. Hard to cut.                                                   ', shots: '1   ', special:      'Retractable Harpoon: Body/Instinct save or become entangled. Does an extra +<u>1d10</u> damage when grapnel is pulled out of target.'},
  {amount: 1, title: 'Scalpel       ', dmg: '1d10        ', crit: '+1d10 DMG and bleeding', range: 'CQC Only     ', special: '+10 (Surgery)'},
  {amount: 1, title: 'SK 109 Seeker Smart Rifle   ', dmg: '<u>1d10</u>', crit: 'x3 DMG                ', range: '25m 200m 500m', ammo: 'Armor Piercing: -10 vs. Armor Save                                                   ', shots: '12  ', special:      'Smart-link system: +10 (Combat if wearing HUD). Spectroscope: Night/Thermal Vision'},
  {amount: 1, title: 'Arma 29 Submachine Gun           ', dmg: '4d10        ', range: '10m 75m 150m ', ammo: 'Fully automatic.                                                                     ', shots: '1(5)', },
  {amount: 1, title: 'Stun Baton    ', dmg: '1d10        ', crit: 'No save               ', range: 'CQC Only     ',  shots: '', special:      'Body save or be stunned for 1 round.'},
  {amount: 1, title: 'D&C 7 Tranquilizer Gun  ', dmg: 'N/A         ', crit: 'No save               ', range: '2m 10m 20m   ', ammo: 'Tranq Darts                                                                          ', shots: '6   ', special:      'Body[+] save or fall unconscious for 1d10 rounds.'},
  {amount: 1, title: 'Vibechete     ', dmg: '2d10        ', crit: 'Hack off limb         ', range: 'CQC Only     ', special:      'Can hack through limbs, or dense forestry, but not metal doors, airlocks, etc.'},
];
