...
export const ITEMS = [
  ...
  {title: 'Kano X9 Combat Shotgun', dmg: '2d10', crit: 'Knockdown', range: '10m 20m 30m  ', ammo: 'Knockback on hit. 1/2 damage at medium range. 1/4 damage at long range.', shots: '4   ', special: 'Audio rangefinder: Beeps when non-friendlies approach within 10m.'},
  {title: 'Crowbar       ', dmg: '1d10        ', range: 'CQC Only     ', special:      '+5 (Mechanical Repair). Confers Advantage on Strength checks to open jammed airlocks, or lift heavy objects.'},
  {title: 'Ramhorn 1 Flamethrower', dmg: '<u>2d10</u>', range: '2m 10m 20m   ', shots: '8   ', special:      'Body save or get set on fire and take <u>1d10</u> dmg. per turn.'},
  {title: 'Peabody Flare Gun     ', dmg: '1d10        ', range: '5m 10m 20m   ', ammo: 'High-intensity flare: Visible from 25km away.                                        ', shots: '2   ', special: ''},
  {title: 'Halls B Series Foam Gun      ', dmg: 'N/A         ', crit: 'No save               ', range: '<1m 5m 10m   ', ammo: 'Quick-hardening foam: Body/instinct save to avoid or become stuck. Foam coveres 5sqm.', shots: '10'  , special:      'Fire retardant.'},
  {title: 'Frag Grenade (x6)  ', dmg: '<u>1d10</u>', range: '20m 30m 40m  ', ammo: 'Deals damage to all within a 15m radius.                                             ', shots: '1   ', special:      'Can often do 1MDMG to a ship if placed in their engine room or bridge.'},
  {title: 'EVA MK-II Hand Welder   ', dmg: '1d10        ', range: 'CQC Only     ', shots: '∞   ', special:      'Ultra heat emitter: Cuts through airlocks/heavy doors. -10 vs. Armor Save'},
  {title: 'MNC Model A Laser Cutter  ', dmg: '1d% or 1MDMG', range: '25m 250m 700m', ammo: 'Takes 1 round to re-charge between shots.                                            ', shots: '6   ', special:      'Takes 1 hour to re-charge from a power source, or 6 hours in sunlight.'},
  {title: 'Rosco 556 Nail Gun      ', dmg: '2d10        ', crit: 'Double damage         ', range: '<1m 5m 10m   ', ammo: 'Heavy Duty Nails: -10 vs. Armor Save                                                 ', shots: '32  ', special:   ''},
  {title: 'F20 “Arbiter” Pulse Rifle   ', dmg: '5d10        ', crit: 'Double damage         ', range: '15m 125m 300m', ammo: 'Phosphorus Rounds. Fully automatic.                                                  ', shots: '1(3)', special:      'Smart-link system: +5 (Combat if wearing HUD). Pump-Action Grenade Launcher: Holds 6 frag grenades.'},
  {title: 'FN “Slug Gun” Revolver      ', dmg: '3d10        ', crit: 'Knockdown             ', range: '2m 30m 125m  ', ammo: 'Kineti-slugs: -5 vs. Armor Save.                                                     ', shots: '8   ', special:   ''},
  {title: 'HAN-290 Rigging Gun   ', dmg: '2d10        ', crit: 'Impale. Triple damage.', range: '10m 30m 100m ', ammo: 'Micro-filament: 500m. Hard to cut.                                                   ', shots: '1   ', special:      'Retractable Harpoon: Body/Instinct save or become entangled. Does an extra +<u>1d10</u> damage when grapnel is pulled out of target.'},
  {title: 'Scalpel       ', dmg: '1d10        ', crit: '+1d10 DMG and bleeding', range: 'CQC Only     ', special: '+10 (Surgery)'},
  {title: 'SK 109 Seeker Smart Rifle   ', dmg: '<u>1d10</u>', crit: 'x3 DMG                ', range: '25m 200m 500m', ammo: 'Armor Piercing: -10 vs. Armor Save                                                   ', shots: '12  ', special:      'Smart-link system: +10 (Combat if wearing HUD). Spectroscope: Night/Thermal Vision'},
  {title: 'Arma 29 Submachine Gun           ', dmg: '4d10        ', range: '10m 75m 150m ', ammo: 'Fully automatic.                                                                     ', shots: '1(5)', },
  {title: 'Stun Baton    ', dmg: '1d10        ', crit: 'No save               ', range: 'CQC Only     ',  shots: '', special:      'Body save or be stunned for 1 round.'},
  {title: 'D&C 7 Tranquilizer Gun  ', dmg: 'N/A         ', crit: 'No save               ', range: '2m 10m 20m   ', ammo: 'Tranq Darts                                                                          ', shots: '6   ', special:      'Body[+] save or fall unconscious for 1d10 rounds.'},
  {title: 'Vibechete     ', dmg: '2d10        ', crit: 'Hack off limb         ', range: 'CQC Only     ', special:      'Can hack through limbs, or dense forestry, but not metal doors, airlocks, etc.'},
];
...
export const LOADOUTS = {
  ...
  exploration: 'Vibechete,HAN-290 Rigging Gun,Peabody Flare Gun,First Aid Kit,Vaccsuit,Long-range Comms,Oxygen Tank,Survey Kit,Water Filter,Locator,Rebreather,Binoculars,Flashlight,Camping Gear,MRE (x7)',
  extermination: 'Arma 29 Submachine Gun,Frag Grenade (x6),Standard Battle Dress,Heads-Up Display,Body Cam,Short-range Comms,Stimpak (x6),Electronic Tool Set',
  examination: 'Scalpel,D&C 7 Tranquilizer Gun,Stun Baton,Hazard Suit,Medscanner,Automed (x6),Pain Pills (x6),Stimpak (x6),Cybernetic Diagnostic Scanner',
};
